...
/*
	...
	$('.header .menu-points-wrapper .menu-point').on('click', function() {
		...
		$('html, body').animate({
			scrollTop :$element.offset().top - 90 //Margin of Textbox + Height of menu div
		},'slow');
	});
